...
public static partial class Marshaler
{
    ...
    private static unsafe void Marshal(AnsiString* text, AnsiString* objT, Tracker state)
    {
    ...
    public static unsafe void Marshal(AnsiString* text, AnsiString** objT, Tracker state)
    {
