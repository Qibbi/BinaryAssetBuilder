...
{
    public class XIncludeReaderWrapper
    {
        private static readonly Tracer _tracer = Tracer.GetTracer(nameof(XIncludeReaderWrapper), "Provides xi:include reading functionality");
